...
def test_atan2(x1, x2):
    ...
    ph.assert_result_shape("atan2", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
...
def test_hypot(x1, x2):
    ...
    ph.assert_result_shape("hypot", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
...
def test_logaddexp(x1, x2):
    ...
    ph.assert_result_shape("logaddexp", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
...
def test_logical_and(x1, x2):
    ...
    ph.assert_result_shape("logical_and", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
    binary_assert_against_refimpl(
...
def test_logical_or(x1, x2):
    ...
    ph.assert_result_shape("logical_or", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
    binary_assert_against_refimpl(
...
def test_logical_xor(x1, x2):
    ...
    ph.assert_result_shape("logical_xor", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
    binary_assert_against_refimpl(
...
def test_maximum(x1, x2):
    ...
    ph.assert_result_shape("maximum", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
...
def test_minimum(x1, x2):
    ...
    ph.assert_result_shape("minimum", in_shapes=[x1.shape, x2.shape], out_shape=tuple(out.shape))
